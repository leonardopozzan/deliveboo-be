...
<div id="order-show">
  ...
  <div class="d-flex flex-wrap justify-content-around">
    <div class="col-12 col-md-6">
      ...
      <div class="p-1 price"><span class="fw-bold">Prezzo Totale:</span> {{$order->total_price}}&nbsp;&euro;</div>
    </div>
    <div class="col-12 col-md-6">
      <h3 class="p-1">Dati Cliente</h3>
      <div class="d-flex flex-wrap">
        <div class="me-5 p-1 col-12 col-xxl-5"><span class="fw-bold">Nome:</span> {{$order->name}}</div>
        <div class="p-1 col-12 col-xxl-5"><span class="fw-bold">Telefono:</span> {{$order->phone_number}}</div>
      </div>
